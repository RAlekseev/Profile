    ...
    <section class="error">
      <div class="error__content">
        <div class="error__message message">
          <h1 class="message__title">Страница не найдена</h1>
          <p class="message__text">Сожалею, но страница которую вы ищете не существует, попробуйте перейти на главную страницу и попробовать снова</p>
        </div>
